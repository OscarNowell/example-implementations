...
final class UserTests: XCTestCase {
    ...
    func test_user_isCachedInvalid_returnsFalseIfInvalid() throws {
    ...
    func test_user_isCacheInvalid_returnsTrueIfValid() throws {
        let cachedUserToTest = CachedUser(user: User(id: "1", name: "Test", email: "testemail"), cachedTime: Date() - 60)

        XCTAssertTrue(cachedUserToTest.isCacheValid(invalidateAfter: 61))
    }
    
    func test_user_isCachedInvalid_returnsFalseIfNoCachedTimeSet() throws {
